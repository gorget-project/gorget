...
- You need a vendor archive (Go/npm/pnpm/yarn/Cargo/Composer/Maven dependencies)
...
| Strip paths from a fetched tarball, pack an explicit file list into an archive, or run an arbitrary command | `transform:` | README [`transform:`](../../README.md#transform) |
